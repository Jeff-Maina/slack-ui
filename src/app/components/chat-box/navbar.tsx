          ...
          <TooltipProvider>
            <Tooltip delayDuration={500}>
              <TooltipTrigger asChild>
                <button className="flex items-center gap-1 text-xs text-neutral-400 hover:text-white px-2 py-1 border border-neutral-700 rounded-lg">
              ...
              >
                <p className="text-sm font-semibold">Notes, todo's, resources and more.</p>
